...
| [`youtube-extension`](extensions/youtube-extension) | Clicks YouTube's Skip button the moment it appears, so a skippable ad is on screen as briefly as possible |
